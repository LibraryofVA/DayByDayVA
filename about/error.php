...
<title><?php echo $title ?> | Day By Day Family-Literacy Calendar</title>
...
<body class="places_page">
  <div id="top_wrap">
	...
	<div id="head_logos">
      <h1><a href="/"><img src="/img/logo.png" alt="Day by Day Family Literacy Calendar" class="logo"></a><span class="month_button"></span><?php echo $error ?></h1>
	</div>
    <div id="content_container">
      <p>&nbsp;</p>
      <p class="heading blueText padded"><?php echo $title ?></p>
    </div>
  </div>
  <div id="bottom_wrap">
